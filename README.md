...
## <span style='color: red;'>Важная информация:</span> доступ к проекту в <span style='color: #387DFF;'>Confluence</span> открыт для всех пользователей <span style='color: #387DFF;' >Confluence</span> у которых есть ссылка 😊
